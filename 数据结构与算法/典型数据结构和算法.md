...
- [8. 排序](#8-排序)
    ...
    - [8.2. 快排（2分）](#82-快排2分)
    - [8.3. 堆排](#83-堆排)
        - [8.3.1. 关于堆的题目：](#831-关于堆的题目)
            - [8.3.1.1. LeetCode218 天际线问题](#8311-leetcode218-天际线问题)
            - [8.3.1.2. LeetCode295 数据流中的中位数](#8312-leetcode295-数据流中的中位数)
    - [8.4. 归并排序](#84-归并排序)
- [9. 二分查找](#9-二分查找)
...
- [15. 其它](#15-其它)
    ...
    - [15.3. 排列组合](#153-排列组合)
    - [15.4. python拓展](#154-python拓展)
        - [15.4.1. heap（heapq）](#1541-heapheapq)
        - [15.4.2. deque（collections）](#1542-dequecollections)
        - [15.4.3. OrderedDict（collections）](#1543-ordereddictcollections)
        - [15.4.4. bisect](#1544-bisect)
        - [15.4.5. math(floor,ceil)](#1545-mathfloorceil)
        - [15.4.6. ord/chr](#1546-ordchr)
...
### 15.4.3. OrderedDict（collections）
